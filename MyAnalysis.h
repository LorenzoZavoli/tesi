...
// Fri Aug  2 22:01:06 2024 by ROOT version 6.30/02
// from TTree OuTree/Reco Event Tree
// found on file: 12C_400_C.root
//////////////////////////////////////////////////////////
...
//la somma di tutti gli elementi di vt_trk_n è il numero di tracce ricostruite. quindi la size di vt_trk_clus_n è quella somma
   ...
   virtual void BeforeLoop_A();
   virtual void Loop_A();
   virtual void AfterLoop_A();
   
   virtual void BeforeLoop_Frac();
   virtual void AfterLoop_Frac();
   ...
   virtual int Z(int& i);
   virtual void Mass(vector<TH1D *> *h_i_1, vector<TH1D *> *h_i_2,
                         vector<TH1D *> *h_i_3, vector<TH2D *> *h_i_1_2,
                         vector<TH2D *> *h_i_2_3, vector<TH2D *> *h_i_1_3);
   virtual void A_Z_solo(vector<TH1D *> *h_i_1, vector<TH1D *> *h_i_2, vector<TH1D *> *h_i_3);
   virtual void compare_A_Z_solo(vector<TGraph *> *g_1_2_Z,
                             vector<TGraph *> *g_2_3_Z,
                             vector<TGraph *> *g_1_3_Z);
   //virtual void Energy_solo(vector<TH1D*> *en);
   virtual void Frac_en_p(vector<TH1D *> *en, vector<TH1D *> *imp);
   ...
   vector<TH2D*> *h_compare_A_1_2_Z;
   vector<TH2D*> *h_compare_A_2_3_Z;
   vector<TH2D*> *h_compare_A_1_3_Z;
   vector<TH1D*> *frac_en;
   vector<TH1D*> *frac_p;
